package com.example.jemberatk.activity
...
import com.example.jemberatk.adapter.AdapterBank
import com.example.jemberatk.app.ApiConfig
import com.example.jemberatk.helper.Helper
import com.example.jemberatk.model.Bank
...
class PembayaranActivity : AppCompatActivity() {
    ...
    fun displayBank() {
        ...
        arrBank.add(Bank("BCA", "092093871237", "Edo Kristian", R.drawable.logo_bca))
        arrBank.add(Bank("BRI", "86721349128", "Edo Kristian", R.drawable.logo_bri))
        arrBank.add(Bank("Mandiri", "02394870329", "Edo Kristian", R.drawable.logo_madiri))
...
//                Toast.makeText(this, "Error:" + t.message, Toast.LENGTH_SHORT).show()
            ...
            override fun onResponse(call: Call<ResponModel>, response: Response<ResponModel>) {
                ...
                if (respon.success == 1) {
                    ...
                    intent.putExtra("chekout", jsCheckout)
